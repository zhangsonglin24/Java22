            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="javascript:;" id="exportXls" class="btn btn-default"><i class="glyphicon glyphicon-paste"></i> 导出Excel</a>
                    </div>
                </div>
                <div class="box-body">
                    <table class="table">
    ...
    $(function () {
        ...
        $(document).delegate(".confirm_btn","click",function(){
            ...
            layer.confirm("确认已收(付)款?",function(index){
                layer.close(index);
                $.post("/report/confirm/"+id).done(function(resp){
        ...
        $("#exportXls").click(function () {
            var day = $("#date").val();
            window.location.href = "/report/day/"+day+"/data.xls";
        })
