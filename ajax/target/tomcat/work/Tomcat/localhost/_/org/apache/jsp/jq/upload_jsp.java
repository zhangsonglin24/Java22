 ...
 * Generated at: 2016-12-11 06:38:45 UTC
...
public final class upload_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<body>\r\n");
      out.write("\r\n");
      out.write("<div id=\"picker\">选择文件</div> <button id=\"startBtn\">开始上传</button>\r\n");
      ...
      out.write("        uploder.on(\"fileQueued\",function(file){\r\n");
      out.write("            var html = \"<li id='\"+file.id+\"'>\"+file.name+\"</li>\";\r\n");
      out.write("            $(\"#fileList\").append($(html));\r\n");
      out.write("        });\r\n");
      out.write("        //文件上传进度,上传过程中调用多次\r\n");
      out.write("        uploder.on(\"uploadProgress\",function(file,percentage){\r\n");
      ...
      out.write("        });\r\n");
      out.write("        //文件上传失败\r\n");
      out.write("        uploder.on(\"uploadError\",function(file){\r\n");
      out.write("            $(\"#\"+file.id).css(\"color\",\"darkred\");\r\n");
      out.write("        });\r\n");
      out.write("        //文件上传成功或失败均调用\r\n");
      out.write("        uploder.on(\"uploadComplete\",function(file){\r\n");
      out.write("            $(\"#\"+file.id).find(\"#bar_\"+file.id).parent().remove();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $(\"#startBtn\").click(function(){\r\n");
      out.write("            uploder.upload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("    });\r\n");
